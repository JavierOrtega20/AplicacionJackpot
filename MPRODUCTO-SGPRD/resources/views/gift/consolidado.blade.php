				...
				<div class="col-md-12">
					<div class="ibox">
                        <div class="ibox-title">
                            <h5>Consolidado GiftCard</h5>
                        </div>						
                        <div class="ibox-content">
                <div class="row">


                 <form method="post" action=" {{ url('gift/consolidado') }} ">
                        {{ csrf_field() }}
                                ...
                                <tbody>
									@foreach ($ventas_giftcard as $key => $gift)
										<tr>
											...
											<td>
												{{ str_replace(".", ",",$gift->total_compras) }} {{ $gift->mon_simbolo }}
											</td>
											<td>
												{{ str_replace(".", ",",$gift->saldo) }} {{ $gift->mon_simbolo }}
											</td>
											<td><a href="{{route('gift.detallecliente',$gift->id)}}" ><i class="fa fa-eye"></i> Detalle </a></td>
										</tr>									
									@endforeach																	                                   
                                </tbody>
                            </table>
