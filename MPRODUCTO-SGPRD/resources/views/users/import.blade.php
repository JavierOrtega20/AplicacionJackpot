...
@section('contenido')
        <div class="row wrapper border-bottom white-bg page-heading">
          <div class="col-lg-8">
            <h2><i class="fa fa-users"></i>   Importar Clientes</h2>
            <ol class="breadcrumb">
              <li>
        ...
        @include('success')
          ...
          <div class="ibox float-e-margins">
              ...
              <div class="ibox-content">
                  <div class="row">
                      <div class="col-sm-6 b-r"><h3 class="m-t-none m-b">Importacion masiva de Clientes</h3>
                         {{--   <p>Ingrese el banco al que pertenecen los miembros e incluya el archivo Excel a exportar.</p> --}}
                          ...
                          {!! Form::open(array('name'=>'f_cargar_datos_usuarios', 'id'=>'f_cargar_datos_usuarios', 'route' => 'users.cargar_datos_usuarios','method'=>'POST', 'class'=>'formarchivo','enctype'=>'multipart/form-data')) !!}
