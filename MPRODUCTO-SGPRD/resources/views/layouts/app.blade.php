...
<head>
    ...
    <link href="{{ asset('js/plugins/dataTables/Buttons-1.6.2/css/buttons.dataTables.css') }}" rel="stylesheet">
...
<div id="divLoading" class="loading" style="display: none;">Cargando</div>
<style>	
