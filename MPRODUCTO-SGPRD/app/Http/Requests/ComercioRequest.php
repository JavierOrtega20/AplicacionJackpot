...
class ComercioRequest extends FormRequest
{
     ...
     public function rules()
    {
        ...
        return [
            ...
            'rif'           => 'required|min:1|max:12',
            'email'           => 'required|email|min:10|max:50',
            'razon_social'      => 'required|min:10|max:50',
            'banco'             => 'required',
            //'codigo_afi_come'   => 'required|unique:comercios,codigo_afi_come',			
    ...
    public function messages()
    {
     return [
            ...
            'rif.min' => 'El Rif debe tener al menos 12 dígitos',
            'rif.min' => 'El Rif debe tener al menos 12 dígitos',
            'email.required' => 'El campo Correo Electrónico es obligatorio',
            'email.min' => 'El Correo Electrónico debe tener al menos 10 carácteres',
            'email.max' => 'El Correo Electrónico debe tener al máximo 50 carácteres',
            ...
            //'codigo_afi_come.requiered' =>  'El Campo Código de Afiliación es obligatorio',
            ...
            'tasa_cobro_comer.max'  =>  'El campo Tasa de Cobro de Comisión debe tener máximo 5 dígitos',
            ...
            'tasa_cobro_comer_dolar.max'  =>  'El campo Tasa de Cobro de Comisión debe tener máximo 5 dígitos',
            ...
            'tasa_cobro_comer_euro.max'  =>  'El campo Tasa de Cobro de Comisión debe tener máximo 5 dígitos',
